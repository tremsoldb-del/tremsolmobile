...
class JobCommentPage extends StatefulWidget {
  final String documentId;

  const JobCommentPage(this.documentId, {super.key});

  @override
  _JobCommentPageState createState() => _JobCommentPageState();
}

class _JobCommentPageState extends State<JobCommentPage> {
