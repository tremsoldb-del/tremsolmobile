...
class PrdSearchPage extends StatefulWidget {
  const PrdSearchPage({super.key});

  @override
  _PrdSearchPageState createState() => _PrdSearchPageState();
}

class _PrdSearchPageState extends State<PrdSearchPage> {
...
Future<void> _loadCurrencyData() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Search Products', style: TextStyle(fontSize: 18)),
      ),
      body: // Inside your build method, replace the body section with:
Column(
  children: [
    Padding(
      ...
      child: TextField(
        ...
        onChanged: (val) {
          _filterResults();
          setState(() {
            _showFinalResults = false; // Show suggestions while typing
          });
        },
