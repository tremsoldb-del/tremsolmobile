...
class WeeklyDealsPage extends StatefulWidget {
  const WeeklyDealsPage({super.key});

  @override
  State<WeeklyDealsPage> createState() => _WeeklyDealsPageState();
}

class _WeeklyDealsPageState extends State<WeeklyDealsPage> {
...
//added 15-12-24
  ...
  Widget build(BuildContext context) {
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const PrdSearchDealsPage(dealTag: 'Weekly'),
                ),
              );
            },
          ),
    ...
    :
        ...
        backgroundColor: AppColors().getColor('weekly'),
  ...
  Widget _buildProductGrid() {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection('products')
          .where('producttag', arrayContainsAny: ['Weekly', 'weekly', 'WEEKLY'])
